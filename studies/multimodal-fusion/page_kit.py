"""Shared furniture for the report page.

The stylesheet and the pieces of page assembly that carry no argument live here;
the narrative stays in `12_build_page.py`. Carried over unchanged from
../expansion-ml-comparison so the two reports read as one series, with the colour
maps repointed at this repository's methods.
"""
...
# Plot colours, so the page and the figures read as one system. These match the
# palettes in 10_report.py and 11_contribution_report.py.
METHOD_COLOR = {
    "lgbm": "#4C72B0",
    "chemprop_st": "#C44E52",
    "chemprop": "#DD8452",
...
# The three design axes, coloured the way the figures colour them.
FUSION_COLOR = {"early": "#4C72B0", "late": "#DD8452", "unimodal": "#8C8C8C"}
MODALITY_COLOR = {
